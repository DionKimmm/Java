...
//		jframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	public void paintColumn(Graphics g, Rectangle column)
	{
		...
		g.drawImage(image3, column.x, column.y, column.x+column.width, column.y+column.height, 0, 0, 190,  column.height/2, null);
	}
	...
	public void repaint(Graphics g) {
		...
		if(gameOver)
		{
			...
			g.drawString("Score : "+String.valueOf(score), 630, HEIGHT/2+20);
			g.drawString("Retry : Space", 570, HEIGHT/2+90);
