...
public class Main extends JFrame {
	...
	public Main() {
		...
		clip.loop(clip.LOOP_CONTINUOUSLY); //오디오 클립 무한 반복 : 음악이 끝나면 처음부터 다시 반복해줍니다.
...
//				new GameExplain();
//				clip.stop();
//				loadAudio("audio/flappy_bgm.wav");
//				clip.start();
...
//		container.add(btn4);
	...
	/*
	 * loadAudio 함수
	 * 오디오 클립에 오디오 스트림 객체를 AudioInputStream으로 생성한 후
	 * 오디오 클립과 오디오 스트림을 clip.open() 으로 연결한다.
	 * 이 함수를 거친 후 clip은 오디오 스트림으로부터 오디오 데이터를 받아 재생할 수 있는 상태가 된다.
