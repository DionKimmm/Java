...
//		jframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	public void repaint(Graphics g) {
		...
		for(int i=kidadult.size()-1; i>=0; i--) {
			...
			if(score<50) {
				if(kidadult1 == kid) {
					g.drawImage(image1, kid.x, HEIGHT-i*40-230, kid.x+kid.width, HEIGHT-i*40-230+kid.height, 0, 0, 128, 128, null);
				}
				if(kidadult1 == adult) {
					g.drawImage(image2, adult.x, HEIGHT-i*40-230, adult.x+adult.width, HEIGHT-i*40-230+adult.height, 0, 0, 128, 128, null);
				}
			}else {
				if(kidadult1 == kid) {
					g.drawImage(image1, kid.x, HEIGHT-i*40-230, kid.x+kid.width, HEIGHT-i*40-230+kid.height, 0, 0, 128, 128, null);
				...
				if(kidadult1 == kid1) {
					g.drawImage(image3, kid.x, HEIGHT-i*40-230, kid.x+kid.width, HEIGHT-i*40-230+kid.height, 0, 0, 128, 128, null);
				}
				if(kidadult1 == adult1) {
					g.drawImage(image4, adult.x, HEIGHT-i*40-230, adult.x+adult.width, HEIGHT-i*40-230+adult.height, 0, 0, 128, 128, null);
				}
			}
		}
...
//		
		...
		if(gameOver)
		{
			...
			g.drawString("Game Over!", 70, HEIGHT/2-80);
			g.setFont(new Font("Arial",1,30));
			g.drawString("Score : "+String.valueOf(score), 120, HEIGHT/2-30);
			g.drawString("Retry : Right/Left", 70, HEIGHT/2+30);
		}
